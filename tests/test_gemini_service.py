...
class TestGeminiService:
    ...
    def test_init_without_api_key(self):
        ...
        with patch('app.services.gemini_service.genai'):
            with pytest.raises(GeminiConfigurationError, match="GEMINI_API_KEY environment variable is required"):
    ...
    def test_should_log_error(self, gemini_service):
        ...
        from app.core.exceptions import GeminiRateLimitError, GeminiAPIError
